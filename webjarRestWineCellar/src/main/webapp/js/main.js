...
var rootURL = "http://localhost:8080/resources/wines";
...
// Add an onClick event to the list, whenever a particular wine gets clicked, 
//the method findById will be called
document.getElementById('wineList').addEventListener('click', function(event) {
    var clickedEl = event.target;
    if(clickedEl.tagName === 'A') {
       var id = clickedEl.getAttribute('data-identity');
       findById(id);
    }
});


//$('#wineList a').on('click', function(e) {
